...
//
// Renders a narrow icon-only column with the primary destinations users
// expect to keep in reach.
  ...
  return (
    <nav className="entry-nav-rail" aria-label="Primary">
      <div className="entry-nav-rail__group">
        {/*
          Hidden for now per sidebar trim request. Restore the brand entry by
          re-adding `const brandLabel = t('app.brand')`, the EntryHelpMenu
          import if needed, and moving this block back before the nav buttons:
        ...
        */}
        ...
        {/*
          Hidden for now. Restore these nav entries by moving them back into
          the group:
      ...
      {/*
        Hidden for now. Restore the footer by re-adding the EntryHelpMenu
        import and moving this block back into the nav:
